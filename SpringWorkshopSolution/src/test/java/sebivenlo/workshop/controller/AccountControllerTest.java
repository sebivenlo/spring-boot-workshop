...
public class AccountControllerTest {
    ...
    public void testIndex() throws Exception {
        ...
        mvc.perform(get("/account/secured/index").with(user("user").password("pass").roles("ADMIN","USER")))
                .andExpect(status().isOk())
                .andExpect(content().contentType(CONTENT_TYPE_HTML))
                .andExpect(view().name("index"))
                .andExpect(model().attribute("account", Matchers.hasProperty("mail", IsNull.nullValue())));
